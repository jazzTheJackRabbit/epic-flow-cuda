...
LAPACKLDFLAGS=-framework Accelerate

LAPACKCFLAGS=-Dinteger=int $(BLAS_THREADING)

CFLAGS=-I/usr/include/malloc -fPIC -Wall -g -O3 -msse4 $(LAPACKCFLAGS) # -fopenmp -DUSE_OPENMP
LDFLAGS=-fPIC -Wall -g -O3 -msse4 -ljpeg -lpng -fopenmp $(LAPACKLDFLAGS) 
