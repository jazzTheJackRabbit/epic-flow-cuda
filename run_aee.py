						...
						if(i < len(files) - 1):
							...
							if(".png" in  ref_image and ".png" in next_image):
								...
								if(sys.argv[1] == "-gpu"):
									...
									subprocess.call(["./run_all.sh", ref_image, next_image, str(base_frame_name + "-edge-file"), str(base_frame_name + "-match-file"), str(base_frame_name + ".flo"),str(base_frame_name + "-flow.png"),"-gpu"])
								elif(sys.argv[1] == "-cpu"):
